...
const categories = ["Phones", "Laptops", "Audio", "Gaming", "Watches", "Cameras", "Displays"];
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-lg border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                { label: "Product name", name: "name", placeholder: "Aero Buds Pro" },
                { label: "Brand", name: "brand", placeholder: "Tronix" },
                { label: "Subcategory", name: "subcategory", placeholder: "Headphones" },
